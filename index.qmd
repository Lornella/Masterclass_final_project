...
value_box(
  ...
  value = lowest_vacc_coverage_2020_number,
...
```{R}
value_box(
  title = "Percent of countries with incidence < 1",
...
```{R}
value_box(
  title = "Highest incidence in 2020",
